        ...
        <div className="flex flex-col xl:flex-row justify-between items-center py-8">
          ...
          <Link href="/">
            <svg width="213" height="50" xmlns="http://www.w3.org/2000/svg">
              <text x="0" y="32" font-family=" " font-size="24" fontWeight='700' fill="white">stefan </text>
              <text x="80" y="32" font-family=" " font-size="24" fill="white" fontWeight='200' letterSpacing='-0.8'>heinemann</text>
              <text x="208" y="32" font-family=" " font-size="24" fill="#ff3225">.</text>
            </svg>
          </Link>
          {/* socials */}
          <Socials />
