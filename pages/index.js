      ...
      <div className="w-full h-full">
        <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto">
          ...
          <motion.p
            ...
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia magnam accusantium earum laborum
            omnis voluptatem atque fugiat perspiciatis commodi officiis laudantium, autem ipsam distinctio
            recusandae delectus possimus, pariatur aut velit.
          </motion.p>
          {/* projects btn */}
